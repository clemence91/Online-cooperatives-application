 ...
 */
@ManagedBean(name = "distreport")
@SessionScoped
public class reportdistrict implements Serializable{
    ...
    public void createPDF() {
        list = new CooperativeDao().getAllByDistrict(test);
        ...
        try { //catch better your exceptions, this is just an example
            ...
            Paragraph pa2 = new Paragraph(new Chunk("COOPERATIVE REGISTERED\n", font2));
            pa2.setAlignment(Element.ALIGN_CENTER);
            Paragraph pa3 = new Paragraph(new Chunk("REPORT BY SECTOR \n", font5));
            pa3.setAlignment(Element.ALIGN_CENTER);
            document.add(pa);
            document.add(pa2);
            document.add(pa3);
            document.add(new Paragraph("\n"));
            document.add(new Paragraph("List of cooperative In :" + new DistrictDao().OneDistrict(test).getDistname()+ "\n"));
            document.add(new Paragraph("\n"));
    ...
    public List<Cooperative> getList() {
        return list;
    }

    public void setList(List<Cooperative> list) {
        this.list = list;
    }
